...
public class MultiHumaneQueryBuilder extends BaseHumaneQueryBuilder<MultiHumaneQueryBuilder> {
    ...
    private static final Logger logger = Loggers.getLogger(MultiHumaneQueryBuilder.class);
    ...
    public static Optional<MultiHumaneQueryBuilder> fromXContent(QueryParseContext parseContext) throws IOException {
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            } else if (parseContext.getParseFieldMatcher().match(currentFieldName, INSTANCE_FIELD)) {
                instance = parser.text();
        ...
        queryBuilder.instance = instance;
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_ARRAY) {
            ...
            if (token.isValue()) {
                ...
                while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                    ...
                    } else if (parseContext.getParseFieldMatcher().match(currentFieldName, KEYWORD_FIELD)) {
                        queryField.keyword = parser.booleanValue();
    ...
    public void doXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(INSTANCE_FIELD.getPreferredName(), this.instance);
        ...
        for (QueryField queryField : queryFields) {
            ...
            builder.field(KEYWORD_FIELD.getPreferredName(), queryField.keyword);
